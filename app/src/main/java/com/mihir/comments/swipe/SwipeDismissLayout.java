...
public class SwipeDismissLayout extends ViewGroup {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwipeDismissLayout);
        setDirectionMode(a.getInt(R.styleable.SwipeDismissLayout_directionMode, mDirectionMode));
        setSwipeBackFactor(a.getFloat(R.styleable.SwipeDismissLayout_swipeBackFactor, swipeBackFactor));
        setMaskAlpha(a.getInteger(R.styleable.SwipeDismissLayout_maskAlpha, maskAlpha));
        isSwipeFromEdge = a.getBoolean(R.styleable.SwipeDismissLayout_isSwipeFromEdge, isSwipeFromEdge);
        a.recycle();
    }
